<template>
  <div v-if="isVisible" class="col-12 h-100 position-absolute top-0 left-0 d-flex justify-content-center align-items-center" @click.self="closeModal"> 
    ...
    <div class="mt-2 d-flex flex-row"> 
      <button @click="changeToDay" id="btn-day" class="rounded m-1 p-1 d-flex justify-content-center align-items-center">
      ...
      <button @click="changeToNight" id="btn-night" class="rounded m-1 p-1 d-flex justify-content-center align-items-center">
      ...
      <h3 class="fs-1 fw-bold mt-5">{{ project.name }}</h3> 
      ...
      <div id="tumbnails" class="mt-3 p-0 col-10 d-flex flex-row justify-content-center align-items-center">
        <img v-if="isDay" v-for="(image, index) in project.imagesDay" :key="index" :src="image" @click="changeImage(index)" class="col-3 m-2" alt="Thumbnail Image">
        <img v-if="isNight" v-for="(image, index) in project.imagesNight" :key="index" :src="image" @click="changeImage(index)" class="col-3 m-2" alt="Thumbnail Image">
      </div>
  ...
  methods: {
    ...
    toggleButtonStyle() {
      ...
      if (btnBack && btnNext) {
        ...
        console.log(`global: ${this.currentImageIndex} ${this.backButtonEnabled}`)
        
        if (this.currentImageIndex >= totalImgsDay - 1) {
          btnNext.setAttribute('class', 'btn-disabled');          
        } 

        if (this.currentImageIndex >= totalImgsNight - 1) {
          btnNext.setAttribute('class', 'btn-disabled');          
        }
